...
Reusable Codex skills for thinking clearly, making better decisions, reviewing engineering tradeoffs, and setting up repositories so Codex can work with them over time.
...
这是一组可复用的 Codex skills，用于澄清想法、做决策、做更可靠的工程取舍，以及为项目建立长期可维护的 Codex 工作上下文。
